...
class Post{
	...
	if($check_empty != "") {
		...
		//If user in on own profile, user_is to 'none'
		if ($user_to == $added_by) {
			$user_to = "none";
		}
	...
	public function loadPostsFriends($data,$limit){
		...
		while ($row = mysqli_fetch_array($data_query)) {
			...
			if($row['user_to'] == 'none'){
				...
				$user_to = "&nbsp&nbsp to &nbsp&nbsp <a href='".$row['user_to']."'>".$user_to_name."</a>";
			}
		...
		if($userLoggedIn == $added_by)
			...
			$str .= "<div class='status_post' onClick='javascript:toggle$id()'>
					<div class='post_profile_pic'>
						...
						<div class='posted_by' style='color:gray; font-size:14px'>	
							<a href='$added_by'> $first_name $last_name </a> $user_to &nbsp;&nbsp;&nbsp;&nbsp; $delete_button<br>$time_message
						</div><br>
						<div id='post_body'>
							$body
						<br>
						...
						<div class= 'newsfeedPostOptions'>
							<div class='comm'>Comments($comments_check_num)</div>
		...
		if($userLoggedIn == $added_by)
			...
			$str .= "<div class='status_post' onClick='javascript:toggle$id()'>
					<div class='post_profile_pic'>
						...
						<div class='posted_by' style='color:gray; font-size:14px'>	
							<a href='$added_by'> $first_name $last_name </a>&nbsp;&nbsp;&nbsp;&nbsp; $delete_button<br>$time_message
						</div><br>
						<div id='post_body'>
							$body
						<br>
...
?>
	...
	<script>
		$(document).ready(function() {
			...
			$('#post<?php echo $id; ?>').on('click', function() {				bootbox.confirm("Are you sure you want to delete this post?", function(result) {
						$.post("includes/form_handlers/delete_post.php?post_id=<?php echo $id; ?>", {result:result});
...
<?php
			...
			echo "<p>You cannot see this post as you are not friends with this person.</p>";
			return;
		}

		}
		else{
			echo "<p>No post found here. If you clicked a link, it may be broken.</p>";
			return;		
		}
