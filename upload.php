...
***********************************************************/	
	...
	//Set Upload directory    
		$uploaddir = $_SERVER['DOCUMENT_ROOT'].'/IG/assets/images/profile_pics';
	//Set File name	
...
<div class="main_column column" style="margin-left: 20%;margin-right: 20%;width:60%;height: 200px;">
	...
	<div id="formExample">
	    ...
	    <form action="upload.php" method="post"  enctype="multipart/form-data">
	        <h4 style="margin-left: 20px;">Update Your Profile Picture</h4><br>
	        <input type="file" id="image" name="image" style="width:400px; height:30px;margin-left: 20px; " /><br><br>
	        <input type="submit" value="Submit" style="    width: 85px; height: 35px; margin-bottom: 40px; background-color: lavender;border: 1.5px solid #4d2e7b;color: black;border-radius: 4px;margin-left: 20px;cursor: hand;font-weight: 600;font-size: 15px;" />
	    </form><br /><br />
